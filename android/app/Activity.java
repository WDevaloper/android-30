...
public class Activity extends ContextThemeWrapper
     ...
     */
    public void finish() {
        //DONT_FINISH_TASK_WITH_ACTIVITY 不会销毁 Activity 所在的任务栈。
    ...
    final void attach(Context context, ActivityThread aThread,
        ...
        //设置该窗口的Callback接口，用于拦截窗口中的按键事件和其他动态操作
        mWindow.setCallback(this);
        ...
        //将系统 WindowManager(WindowManagerImpl) 传给 PhoneWindow
